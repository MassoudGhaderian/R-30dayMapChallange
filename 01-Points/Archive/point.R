...
oppervlaktewater <- st_read("/R-WorkSpace/30DayMapChallenge2024 by Rbanism/01-Points/shp/oppervlaktewater.shp")
head(oppervlaktewater)


#add populated places
populated_palces <- st_read("/R-WorkSpace/30DayMapChallenge2024 by Rbanism/01-Points/shp/populated_places.shp")
head(populated_palces)

#add provinces
provinces <- st_read("/R-WorkSpace/30DayMapChallenge2024 by Rbanism/01-Points/shp/provinces.shp")
head(populated_palces)

# add sea
NorthSea <- st_read("/R-WorkSpace/30DayMapChallenge2024 by Rbanism/01-Points/shp/NorthSea.shp")


#add border
nl_border <- st_read("/R-WorkSpace/30DayMapChallenge2024 by Rbanism/01-Points/shp/netherlands_border.shp")

#add Netherlands boundry
NL0 <- st_read("/R-WorkSpace/30DayMapChallenge2024 by Rbanism/01-Points/shp/gadm41_NLD_shp/gadm41_NLD_0.shp")

#add stats boundry
NL1 <- st_read("/R-WorkSpace/30DayMapChallenge2024 by Rbanism/01-Points/shp/gadm41_NLD_shp/gadm41_NLD_1.shp")

#add cities boundry
NL2 <- st_read("/R-WorkSpace/30DayMapChallenge2024 by Rbanism/01-Points/shp/gadm41_NLD_shp/gadm41_NLD_2.shp")
